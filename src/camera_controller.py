...
class ControllerMode(Enum):
    ...
    PREDICTIVE_SERVO = auto()  # Moving camera along Kalman predicted position during occlusion
...
class CameraController:
    """Pan/Tilt motion controller driving VirtualCamera to keep beacon centered."""
    ...
    def update(
        ...
        Algorithm:
        1. Determine controller mode from tracking state:
        ...
        3. Apply deadband threshold to eliminate micro-jitter.
