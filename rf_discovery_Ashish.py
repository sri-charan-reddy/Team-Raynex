...
DEFAULT_SIMULATED_TERMINALS = {
    "TERMINAL_01": {
        ...
        "position": (10, 8),
        "shared_secret": "ISRO_FSOC_KEY_01"
    },
    "TERMINAL_02": {
        "terminal_id": "TERMINAL_02",
        "position": (7.88, 6.15),
        "shared_secret": "ISRO_FSOC_KEY_02"
    },
    "TERMINAL_03": {
        "terminal_id": "TERMINAL_03",
        "position": (-5, 10),
        "shared_secret": "ISRO_FSOC_KEY_03"
    }
}

# Verifier's trusted registry containing expected shared secrets for known terminals
TRUSTED_TERMINALS_REGISTRY = {
    "TERMINAL_01": "ISRO_FSOC_KEY_01",
    "TERMINAL_02": "ISRO_FSOC_KEY_02",
    "TERMINAL_03": "ISRO_FSOC_KEY_03"
}
